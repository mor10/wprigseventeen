 ...
 */
function wprig_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'wprig_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.wprig-front-page) .entry-title,
...
.colors-custom .wprig-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.wprig-front-page .panel-content .recent-posts article,
...
.colors-custom.wprig-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'wprig_custom_colors_css', $css, $hue, $saturation );
}
